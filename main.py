...
def get_weather():
  ...
  return weather['weather'],weather['data'],  math.floor(weather['temp']), math.floor(weather['high']), math.floor(weather['low'])
